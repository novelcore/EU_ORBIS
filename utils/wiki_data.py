...
from utils.ReFinED_ok.src.refined.inference.processor import Refined
...
def wiki_info(text: str) -> Dict[str, Any]:
    ...
    A = refined.process_text_batch(texts=[text], return_special_spans=False, max_batch_size=8)
