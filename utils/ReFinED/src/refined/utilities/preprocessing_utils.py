...
from utils.ReFinED.src.refined.data_types.doc_types import (
    Doc,
)
from utils.ReFinED.src.refined.data_types.modelling_types import BatchElementTns, BatchedElementsTns, BatchElement
from utils.ReFinED.src.refined.doc_preprocessing.preprocessor import Preprocessor
from utils.ReFinED.src.refined.model_components.mention_detection_layer import IGNORE_INDEX
from utils.ReFinED.src.refined.utilities.general_utils import batch_items
